...
module.exports = {
    apps: [
        {
            // name: cwd + "-" + "task-manager-872612",
            script: 'src/',
            instance_var: 'INSTANCE_ID',
            appendEnvToName: true,
            // Standard Output (console.log) will go here
            //out_file: "/home/ubuntu/app/logs/task-manager-872612stg-out.log",
            // Error Output (console.error) will go here
            //error_file: "/home/ubuntu/app/logs/task-manager-872612-stg-error.log",
