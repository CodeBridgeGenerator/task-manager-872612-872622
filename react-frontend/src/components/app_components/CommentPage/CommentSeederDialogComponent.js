...
import seederData from "./comment.seeder.json";
...
const CommentSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CommentSeederDialogComponent);
