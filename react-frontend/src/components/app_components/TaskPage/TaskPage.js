...
const TaskPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("task")
            .find({ query: { $limit: 10000 , assignedPerson : urlParams.singleUsersId ,project : urlParams.singleProjectId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="task-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="task-datatable">
