...
import seederData from "./project.seeder.json";
...
const ProjectSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProjectSeederDialogComponent);
