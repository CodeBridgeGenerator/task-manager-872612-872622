...
const StaffinfoCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create Staffinfo" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: '40vw' }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto" style={{ maxWidth: '55vw' }} role="staffinfo-create-dialog-component">
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="empno" className="w-full mb-3 p-inputtext-sm" value={_entity?.empno} onChange={(e) => setValByKey('empno', e.value)} tooltip="Use only numbers" />
                    </span>
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="compcode" className="w-full mb-3 p-inputtext-sm" value={_entity?.compcode} onChange={(e) => setValByKey('compcode', e.value)} tooltip="Use only numbers" />
                    </span>
                    <small className="p-error">
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="sectcode" className="w-full mb-3 p-inputtext-sm" value={_entity?.sectcode} onChange={(e) => setValByKey('sectcode', e.value)} tooltip="Use only numbers" />
                    </span>
                    <small className="p-error">
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="datejoin" className="w-full mb-3 p-inputtext-sm" value={_entity?.datejoin} onChange={(e) => setValByKey('datejoin', e.value)} tooltip="Use only numbers" />
                    </span>
                    <small className="p-error">
