...
const FcmMessageDataTable = ({
    ...
    const inputTextareaTemplate1 = (rowData, { rowIndex }) => <p>{rowData.body}</p>;
    const dropdownTemplate2 = (rowData, { rowIndex }) => <p>{rowData.recipients?.name}</p>;
    const imageTemplate3 = (rowData, { rowIndex }) => <Image src={rowData.image} alt="Image" height="60px" />;
    const dropdownTemplate4 = (rowData, { rowIndex }) => <p>{rowData.from?.name}</p>;
    ...
    return (
        <>
            ...
            >
                ...
                <Column field="body" header="Body" body={inputTextareaTemplate1} filter={selectedFilterFields.includes('body')} hidden={selectedHideFields?.includes('body')} sortable style={{ minWidth: '8rem' }} />
                <Column field="recipients" header="Recipients" body={dropdownTemplate2} filter={selectedFilterFields.includes('recipients')} hidden={selectedHideFields?.includes('recipients')} style={{ minWidth: '8rem' }} />
                {/* <Column field="image" header="Image" body={imageTemplate3} filter={selectedFilterFields.includes("image")} hidden={selectedHideFields?.includes("image")}  sortable style={{ minWidth: "8rem" }} /> */}
                <Column field="from" header="From" body={dropdownTemplate4} filter={selectedFilterFields.includes('from')} hidden={selectedHideFields?.includes('from')} style={{ minWidth: '8rem' }} />
            ...
            <Dialog header="Upload FcmMessage Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService
                    user={user}
            ...
            <Dialog header="Search FcmMessage" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
...
export default FcmMessageDataTable;
