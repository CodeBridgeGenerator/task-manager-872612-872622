...
const NotificationTemplatesDataTable = ({
    items,
    fields,
    onEditRow,
    onRowDelete,
    ...
    const pTemplate2 = (rowData, { rowIndex }) => <p>{rowData.body}</p>;
    const pTemplate3 = (rowData, { rowIndex }) => <p>{rowData.image}</p>;
    ...
    return (
        <>
            ...
            >
                ...
                <Column field="body" header="Body" body={pTemplate2} filter={selectedFilterFields.includes('body')} hidden={selectedHideFields?.includes('body')} sortable style={{ minWidth: '8rem' }} />
                <Column field="image" header="Image" body={pTemplate3} filter={selectedFilterFields.includes('image')} hidden={selectedHideFields?.includes('image')} sortable style={{ minWidth: '8rem' }} />
            ...
            <Dialog header="Upload Notification Templates Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService
                    user={user}
                    serviceName="notificationTemplates"
                    onUploadComplete={() => {
            ...
            <Dialog header="Search NotificationTemplates" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
...
export default NotificationTemplatesDataTable;
