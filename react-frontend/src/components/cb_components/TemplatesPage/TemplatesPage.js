...
const TemplatesPage = (props) => {
    ...
    const onRowClick = ({ data }) => {
        navigate(`/cbAdmin/templates/${data._id}`);
    };
    ...
    return (
        <div className="mt-5">
            <div className="grid">
                ...
                <div className="col-6 flex justify-content-end">
                    <>
                        ...
                        ></SplitButton>
                        <Button label="add" style={{ height: '30px', marginRight: '10px' }} rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="templates-add-button" />
                    </>
                </div>
            </div>
            ...
            <TemplatesCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} />
