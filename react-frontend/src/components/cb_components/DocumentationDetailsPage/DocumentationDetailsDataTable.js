...
const DocumentationDetailsDataTable = ({
    ...
    // New View Template
    const viewTemplate = (rowData) => <Button icon="pi pi-eye" onClick={() => window.open(rowData.documentationFile?.url, '_blank')} className="p-button-rounded p-button-text p-button-info" tooltip="View PDF" tooltipOptions={{ position: 'top' }} />;
