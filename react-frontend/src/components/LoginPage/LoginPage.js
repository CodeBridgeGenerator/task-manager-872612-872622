...
const LoginPage = (props) => {
    ...
    const projectName = process.env.REACT_APP_PROJECT_LABEL || process.env.REACT_APP_PROJECT_NAME;
                ...
                props
                    ...
                    .then(async (res) => {
                        try {
                            ...
                            client.service('loginHistories').create({
                                userId: res.user._id,
                                ...deviceDetails,
                    ...
                    <div className="w-full px-3 mx-3 card md:px-7">
                        ...
                        <div>
                            <div className="w-full mb-4">
                                ...
                                <InputText type="text" placeholder={isEmail ? 'Enter your registered email' : 'Enter your registered Staff Id'} value={email} onChange={(e) => setEmail(e.target.value)} className={classNames(emailError ? 'p-invalid' : '', 'w-full')} onKeyDown={onEnter} />
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link onClick={() => setEmailOrStaffId((prev) => !prev)} className="m-0 text-sm font-semibold cursor-pointer !text-link">
